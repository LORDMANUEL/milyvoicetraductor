  ...
  <div class="onboarding-card">
    <div class="onboarding-brand">
      ...
      <div>
        ...
        <p>El instalador prepara el runtime privado, el motor y Native Messaging. Los modelos se eligen y descargan después, dentro del Gestor de modelos.</p>
      </div>
    </div>
    ...
    <div class="onboarding-steps">
      ...
      <article>
        ...
        <div><strong>Modelos compatibles</strong><small>Se mostrarán dentro del Gestor de modelos para que el usuario elija cuándo descargarlos.</small></div>
        <b>→</b>
      </article>
